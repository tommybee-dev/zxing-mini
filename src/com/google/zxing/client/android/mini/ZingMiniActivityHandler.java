 ...
 */
public final class ZingMiniActivityHandler extends Handler {

	private static final String TAG = ZingMiniActivityHandler.class.getSimpleName();

	private final ZxingMiniActivity activity;
	...
	ZingMiniActivityHandler(ZxingMiniActivity activity, Collection<BarcodeFormat> decodeFormats,
	...
	public void handleMessage(Message message) {
		...
		case R.id.decode_failed:
			...
			//BlazeLog.logD(TAG, "handleMessage>>decode_failed"); <== too many decode messages created
